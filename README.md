...
| PUT    | `/empreendimentos/:id`      | Edição de empreendimento               | Sim       | [Exemplo de uso](#✏️-editar-empreendimento-rota-protegida) |
...
[Veja o exemplo de requisição em Editar Empreendimento](#✏️-editar-empreendimento-rota-protegida)
